...
public class SaleVisit {
	...
	public String getVisit_time_s() {
		...
		return transferString(visit_time, "yyyy-MM-dd");
	}
	public String getVisit_nexttime_s() {
		if(visit_time==null){return " ";}
		return transferString(visit_nexttime, "yyyy-MM-dd");
	}
	
	public static String transferString(Date date,String format){
